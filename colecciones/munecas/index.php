...
if ($conexion->connect_error) {
    ...
    //Accesorios -> Muñecas 1
    $consulta = "SELECT * FROM Productos WHERE coleccion = 1";
...
<body class="coleccion-individual-page">
    ...
    <section class="main-colecciones-sp">
        <h1>Muñecas</h1>
        <p>Conoce todas las muñecas disponibles en Star Toys</p>
